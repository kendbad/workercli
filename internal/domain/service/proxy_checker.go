...
type BoKiemTraTrungGian interface {
	KiemTraTrungGian(trungGian model.TrungGian, duongDanKiemTra string) (ip string, trangThai string, err error)
}
...
// Chúng ta chỉ cần tạo một struct mới và implement interface BoKiemTraTrungGian.
